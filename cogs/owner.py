...
#from discord.ext.commands.Bot.login import 
...
class owner(commands.Cog, name="owner"):
    ...
    async def say(self, context, *, args):
        """
        The bot will say anything you want in any current channel.
        """
        
        await context.send(args)

    @commands.command(name="embeds")
    async def embeds(self, context, *, args):
        """
